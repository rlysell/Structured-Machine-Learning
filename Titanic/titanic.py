...
Original file is located at
    https://colab.research.google.com/drive/11w_aXwOQ8K82YL4wigc1N8S-WTIIB8gE
"""
...
if __name__ == '__main__':
  ...
  inp = int(input("Choose 1 for class model and 2 for Sequential: "))
  if inp == 1:
    use_class_model()
  elif inp == 2:
    use_Sequential_model()
  else:
    print("Invalid input!")